...
## Course Schedule
---
- Overall schedule: 16 chapters total, 150 min each on average (equivalent to 3-credit course). Note that the Chapter 16, as the supplementary chapter, has a bunch of topics, so it'll be longer though not being core content.
